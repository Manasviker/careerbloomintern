...
import React, { useEffect, useState } from "react";
  ...
  //     company: "IT Hub",
  //     location: "Pune",
  //     CTC: "Rs.30,0000 - Rs.110,000",
  //     Experience: "3-5 years",
  //     category: "Engineering",
  //     StartDate: "March 20, 2025",
  //     aboutCompany:
  //       "IT Hub Solutions specializes in building scalable backend systems and APIs for high-performance applications.",
  //     aboutJob:
  ...
  useEffect(()=>{
    const fetchdata=async()=>{
      try {
        const res=await axios.get( "https://careerbloomintern.onrender.com/api/job")     
        setjob(res.data)
