...
import {ArrowUpRight,Book,Clock,ExternalLink,IndianRupee,MapPin,X,} from "lucide-react";
...
// };
  ...
  useEffect(() => {
    const fetchdata = async () => {
      try {
        const res = await axios.get(`https://careerbloomintern.onrender.com/api/job/${id}`);
        setjob(res.data);
      } catch (error) {
        console.log(error);
      }
